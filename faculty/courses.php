                        ...
                        <div class="panel-body">
                            <div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <tbody>
<?php
$sql=mysqli_query($con,"select * from course where instructorid=(select facultyid from faculty where username='".$_SESSION['alogin']."')");
$cnt=1;
...
?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href="classlist.php?id=<?php echo $row['id']?>">
<button class="btn btn-primary"><i class="fa fa-edit "></i>View class list</button> </a>                                        
