...
$ret=mysqli_query($con,"update course set courseCode='$coursecode',courseName='$coursename',courseUnit='$courseunit',noofSeats='$seatlimit',updationDate='$currentTime',instructorid=(select facultyid from faculty where name='$Fa') where id='$id'");
if($ret)
{
...
<div class="form-group">
    <label for="Session">Assigned Instructor</label>
